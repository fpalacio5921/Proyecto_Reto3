package com.example.bdsqlite.modelos.productos;
...
public class ProductoAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tvCampo1.setText(producto.getName());
        tvCampo2.setText(producto.getDescription());
        tvCampo3.setText(producto.getPrice());
